...
public class MongoUtils {
    ...
    public static void main( String args[] ) {
            ...
            try {
                ...
                MongoCollection<Document> col = mongoDatabase.getCollection("test2");
                FindIterable<Document> documents = col.find();
                System.out.println("first col documents : " + documents.first());

                MongoCursor<Document> mongoCursor = documents.iterator();
                // 通过游标遍历检索出的文档集合
                while (mongoCursor.hasNext()) {
                    System.out.println("cur document : " + mongoCursor.next());
                }
